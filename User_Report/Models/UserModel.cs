...
namespace User_Report.Models
{
    ...
    public class listcompliant
    {
        ...
        public double? developer_id { get; set; } // Made nullable to handle possible null values
        public int? developer_idAsInteger => developer_id.HasValue ? (int?)developer_id : null;
